...
if(isset($_POST['dodaj'])){
    ...
    if(Avion::unesiAvion($model, $opis, $tip, $proizvodjac, $konekcija)){
...
<body>
  ...
  <section id="maincontent">
    <div class="container">
      <div class="row">
        <h1>Forma za dodavanje aviona</h1>
          <form method="post" action="">
              <label for="model">Model</label>
              <input type="text" class="form-control" name="model" id="model" style="border: 1px solid lightgrey">

              <label for="opis">Opis</label>
              <textarea rows="5" class="form-control" name="opis" id="opis" style="border: 1px solid lightgrey">
